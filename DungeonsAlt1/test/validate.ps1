...
if (($app -notmatch 'map-core\.js\?v=20260625-7') -or
    ($app -notmatch 'alt1-map-locator\.js\?v=20260625-7') -or
    ($app -notmatch 'rpm-state\.js\?v=20260625-7') -or
    ($app -notmatch 'team-sync\.js\?v=20260625-7') -or
    ($app -notmatch 'party-core\.js\?v=20260625-7') -or
    ($app -notmatch 'results-core\.js\?v=20260625-7') -or
    ($app -notmatch 'party-menu\.js\?v=20260625-7') -or
    ($app -notmatch 'team-gates\.js\?v=20260625-7') -or
    ($app -notmatch 'file-saver\.js\?v=20260625-7') -or
    ($app -notmatch 'party-anchor\.js\?v=20260625-7') -or
    ($overlay -notmatch 'map-core\.js\?v=20260625-7') -or
    ($overlay -notmatch 'rpm-state\.js\?v=20260625-7') -or
    ($teamSync -notmatch 'party-core\.js\?v=20260625-7') -or
    ($teamGates -notmatch 'party-core\.js\?v=20260625-7') -or
    ($teamGates -notmatch 'alt1-overlay\.js\?v=20260625-7') -or
    ($partyAnchor -notmatch 'party-interface\.js\?v=20260625-7') -or
    ($mapLocator -notmatch 'map-core\.js\?v=20260625-7')) {
